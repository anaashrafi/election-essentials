  ...
  <body>
    <header>
      ...
      <div id="candidatePicture"> <!---cards are a href to make the whole thing clickable --->
        <img src="https://pbs.twimg.com/profile_images/874276197357596672/kUuht00m_400x400.jpg" alt="Donald Trump"></img>
      </div>
      ...
      <div id="candidateStance">
        ...
        <div style="display: inline-block; text-align:left;">
          <p>
            Gun Laws: Leans conservative<br>
            Reproductive Issues: Leans conservative<br>
            LGBTQ+ Issues: Leans conservative<br>
            Healthcare: Leans conservative
          </p>
          </div>
        <br>
      </div>
      ...
      <div id="learnMore">
        <br>
        <p>
          Learn more about Donald Trump's campaign at <a href= "https://www.donaldjtrump.com/">here.</a>
        </p>
        <br>
      </div>
    </header>
